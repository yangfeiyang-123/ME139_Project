# Adapted from HybridRobotics/whole_body_tracking (MIT; see third_party/whole_body_tracking/LICENCE).
# Local output, bounded execution, and single-GPU launch for this project.
...
parser.add_argument("--output_file", type=Path, required=True, help="Local output NPZ path.")
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene, joint_names: list[str]):
    ...
    while simulation_app.is_running():
        ...
        if reset_flag and not file_saved:
            ...
            print(f"MOTION_CONVERSION_PASSED: {args_cli.output_file.resolve()}")
            return
